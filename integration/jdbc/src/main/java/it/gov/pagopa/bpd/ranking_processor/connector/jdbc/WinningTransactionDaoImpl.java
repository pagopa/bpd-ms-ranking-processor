...
class WinningTransactionDaoImpl implements WinningTransactionDao {
    ...
    public WinningTransactionDaoImpl(@Qualifier("winningTransactionJdbcTemplate") JdbcTemplate jdbcTemplate,
        ...
        updateProcessedTrxSql = String.format("update bpd_winning_transaction set %s = true where id_trx_acquirer_s = :idTrxAcquirer and wt.acquirer_c = :acquirerCode and wt.trx_timestamp_t = :trxDate and wt.operation_type_c = :operationType and wt.acquirer_id_s = :acquirerId", elabRankingName);
    }
